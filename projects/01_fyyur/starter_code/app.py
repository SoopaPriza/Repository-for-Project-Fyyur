...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:vn4%3E%5EZ%274DELyK%2Bv%2B@localhost:5432/pfyyurdb'
...
class Venue(db.Model):
    ...
    shows = db.relationship('Show', backref='Venue', cascade="delete")
